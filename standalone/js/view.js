	class View {
	  ...
	  displayClasses(data) {
	    var eThis = this;
	  	if("results" in data && "bindings" in data["results"] && data["results"]["bindings"].length) {
	  		...
	  		//Hide ellipses
	  		$("#loadingClasses").addClass("d-none");
	  ...
	  displayIndividualClass(classURI) {
	  	...
	  	return "<div class='row' uri='" + classURI + "'><div class='col-8'>" + classURI + "</div><div class='col-2' role='count'><div class='dot-elastic'></div></div><div class='col-2' role='examples'><a href='" + classLink + "'>Examples</a></div></div>";
	  }
