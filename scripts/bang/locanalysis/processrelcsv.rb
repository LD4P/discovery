...
def check_file_grouped(filename, id_type)		
 ...
 puts "total isbn by property count:" + prop_total_isbn_c.to_s
 ...
 puts "Matching isbn by property count:" + prop_match_isbn_c.to_s
end
...
check_file_grouped("prophubsets.csv", "isbn") 
