...
require 'json'
require 'set'
#This file is for processing LCCNs for hub aggregations (under the same hub, not by property)
...
#This has been updated to look at lccns specifically
def execute_solr_query(solr_query)
	#Replace with appropriate Solr URL for your own system. This SOLR index is a copy of our production catalog index
...
check_file_grouped("HubSetsLccn.csv", "lccn") 
